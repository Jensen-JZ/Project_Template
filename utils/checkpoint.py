...
class CheckpointManager:
    ...
    def __init__(self, ckpt_path_template, multi_gpu=False, **kwargs):
        """
        Initializes the CheckpointManager with a path template and registered modules.

        Ensures the directory for the ckpt path exists and registers modules to be saved/loaded.
